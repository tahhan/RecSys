...
<html>
   <head>
      ...
      <?php $doo_view_basic_1342464898 = $data['page_js'];
if (!empty($doo_view_basic_1342464898)):
foreach($doo_view_basic_1342464898 as $data['jsfile']):
?>
      ...
      <script type="text/javascript">
         ...
         <?php $doo_view_basic_1342464899 = $data['page_js_vars'];
if (!empty($doo_view_basic_1342464899)):
foreach($doo_view_basic_1342464899 as $data['key']=>$data['value']):
?>
   ...
   <body id="<?php echo $data['template']; ?>-<?php echo $data['page']; ?>" class="bp <?php echo $data['lang']; ?> <?php echo $data['template']; ?> <?php echo $data['page']; ?>">
      ...
      <div id="wrapper" class="container" >
         <div class="flash-container">
            <?php $doo_view_basic_1342464900 = $data['flash'];
if (!empty($doo_view_basic_1342464900)):
foreach($doo_view_basic_1342464900 as $data['f_key']=>$data['f']):
?>
	...
	if($data['page_path'] != DooViewBasic::$safeVariableResult){
		$doo_view_basic_1342464901 = $this->compileSubView($data['page_path']);
		if ($doo_view_basic_1342464901[0] == true) {
			include $doo_view_basic_1342464901[1];
		} else {
			echo $doo_view_basic_1342464901[1];
		}
	} else {
