...
<fieldset>
   ...
   <div class="info-line">
      ...
      <ul>
         <?php $doo_view_basic_1307884069 = $data['seeker']->nationalities;
if (!empty($doo_view_basic_1307884069)):
foreach($doo_view_basic_1307884069 as $data['nationalitie']):
?>
...
<fieldset>
   ...
   <div class="info-line">
      <span>Languages :</span>
      <?php $doo_view_basic_1307884070 = $data['seeker']->SeekerProfessionalInfo->lang_list;
if (!empty($doo_view_basic_1307884070)):
foreach($doo_view_basic_1307884070 as $data['lang']):
?>
      <ul>
