...
<html>
   <head>
      ...
      <?php $doo_view_basic_1308130632 = $data['page_js'];
if (!empty($doo_view_basic_1308130632)):
foreach($doo_view_basic_1308130632 as $data['jsfile']):
?>
      ...
      <script type="text/javascript">
         ...
         <?php $doo_view_basic_1308130633 = $data['page_js_vars'];
if (!empty($doo_view_basic_1308130633)):
foreach($doo_view_basic_1308130633 as $data['key']=>$data['value']):
?>
   ...
   <body id="<?php echo $data['template']; ?>-<?php echo $data['page']; ?>" class="bp <?php echo $data['lang']; ?> <?php echo $data['template']; ?> <?php echo $data['page']; ?>">
      ...
      <div id="wrapper" class="container" >
         <div class="flash-container">
            <?php $doo_view_basic_1308130634 = $data['flash'];
if (!empty($doo_view_basic_1308130634)):
foreach($doo_view_basic_1308130634 as $data['f_key']=>$data['f']):
?>
	...
	if($data['page_path'] != DooViewBasic::$safeVariableResult){
		$doo_view_basic_1308130635 = $this->compileSubView($data['page_path']);
		if ($doo_view_basic_1308130635[0] == true) {
			include $doo_view_basic_1308130635[1];
		} else {
			echo $doo_view_basic_1308130635[1];
		}
	} else {
