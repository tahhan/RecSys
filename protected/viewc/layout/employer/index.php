...
<html>
   <head>
      ...
      <?php $doo_view_basic_1308130536 = $data['page_js'];
if (!empty($doo_view_basic_1308130536)):
foreach($doo_view_basic_1308130536 as $data['jsfile']):
?>
      ...
      <script type="text/javascript">
         ...
         <?php $doo_view_basic_1308130537 = $data['page_js_vars'];
if (!empty($doo_view_basic_1308130537)):
foreach($doo_view_basic_1308130537 as $data['key']=>$data['value']):
?>
   ...
   <body id="<?php echo $data['template']; ?>-<?php echo $data['page']; ?>" class="bp <?php echo $data['lang']; ?> <?php echo $data['template']; ?> <?php echo $data['page']; ?>">
      ...
      <div id="wrapper" class="container" >
         <div class="flash-container">
            <?php $doo_view_basic_1308130538 = $data['flash'];
if (!empty($doo_view_basic_1308130538)):
foreach($doo_view_basic_1308130538 as $data['f_key']=>$data['f']):
?>
	...
	if($data['page_path'] != DooViewBasic::$safeVariableResult){
		$doo_view_basic_1308130539 = $this->compileSubView($data['page_path']);
		if ($doo_view_basic_1308130539[0] == true) {
			include $doo_view_basic_1308130539[1];
		} else {
			echo $doo_view_basic_1308130539[1];
		}
	} else {
